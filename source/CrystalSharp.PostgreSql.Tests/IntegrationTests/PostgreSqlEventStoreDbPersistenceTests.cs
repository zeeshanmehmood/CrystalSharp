...
namespace CrystalSharp.PostgreSql.Tests.IntegrationTests
{
    ...
    public class PostgreSqlEventStoreDbPersistenceTests(PostgreSqlEventStoreTestFixture fixture) : IClassFixture<PostgreSqlEventStoreTestFixture>
    {
        private readonly PostgreSqlEventStoreTestFixture _testFixture = fixture;
