...
namespace CrystalSharp.Tests.UnitTests.Aggregates
{
    ...
    public class AggregateRootTests
    {
        ...
        public void Name_and_code_are_equal()
        {
            ...
            CurrencyDetails currencyDetails = new("PKR", 586);

            // Act
            Currency sut = Currency.Create(name, currencyDetails);

            // Assert
            using (new AssertionScope())
            {
                sut.Name.Should().Be("Pakistani rupee");
                sut.CurrencyDetails.Code.Should().Be("PKR");
                sut.CurrencyDetails.NumericCode.Should().Be(586);
            }
        }
        ...
        public void Contains_one_event()
        {
            // Arrange
            string name = "Euro";
            CurrencyDetails currencyDetails = new("EUR", 978);
            Currency sut = Currency.Create(name, currencyDetails);
        ...
        public void Contains_created_event()
        {
            ...
            CurrencyDetails currencyDetails = new("USD", 840);
            Currency sut = Currency.Create(name, currencyDetails);
        ...
        public void New_name_code_and_symbol_are_equal()
        {
            ...
            string newName = "Euro";
            CurrencyDetails currencyDetails = new("HUF", 348);
            CurrencyDetails newCurrencyDetails = new("EUR", 978);
            Currency sut = Currency.Create(name, currencyDetails);

            // Act
            sut.ChangeName(newName);
            sut.ChangeDetails(newCurrencyDetails);

            // Assert
            using (new AssertionScope())
            {
                sut.Name.Should().Be("Euro");
                sut.CurrencyDetails.Code.Should().Be("EUR");
                sut.CurrencyDetails.NumericCode.Should().Be(978);
            }
        }
        ...
        public void Contains_three_events()
        {
            ...
            string newName = "Euro";
            CurrencyDetails currencyDetails = new("TRY", 949);
            CurrencyDetails newCurrencyDetails = new("EUR", 978);
            Currency sut = Currency.Create(name, currencyDetails);
        ...
        public void Contains_deleted_event()
        {
            ...
            CurrencyDetails currencyDetails = new("HUF", 348);
            CurrencyDetails newCurrencyDetails = new("LVL", 111);
            Currency sut = Currency.Create(name, currencyDetails);
            sut.ChangeName(newName);
            sut.ChangeDetails(newCurrencyDetails);
        ...
        public void Contains_zero_event()
        {
            ...
            string newName = "Euro";
            CurrencyDetails currencyDetails = new("LVL", 111);
            CurrencyDetails newCurrencyDetails = new("EUR", 978);
            Currency sut = Currency.Create(name, currencyDetails);
            sut.ChangeName(newName);
            sut.ChangeDetails(newCurrencyDetails);
        ...
        public void Raise_name_validation_exception()
        {
            ...
            // Act
            Action sut = () => Currency.Create(name, currencyDetails);
        ...
        public void Raise_code_validation_exception()
        {
            // Arrange
            string name = "Euro";
            CurrencyDetails currencyDetails = new(string.Empty, 978);
        ...
        public void Raise_code_length_validation_exception()
        {
            // Arrange
            string name = "Euro";
            CurrencyDetails currencyDetails = new("EuroEUR", 978);
        ...
        public void Raise_numeric_code_validation_exception()
        {
            // Arrange
            string name = "Euro";
            CurrencyDetails currencyDetails = new("EUR", -1);
        ...
        public void Raise_numeric_code_length_validation_exception()
        {
            // Arrange
            string name = "Euro";
            CurrencyDetails currencyDetails = new("Euro", 0978);
