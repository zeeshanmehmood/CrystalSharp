...
namespace CrystalSharp.Sagas.Tests.IntegrationTests
{
    ...
    public class MySqlSagaChoreographyTests(MySqlSagaTestFixture fixture) : IClassFixture<MySqlSagaTestFixture>
    {
        private readonly MySqlSagaTestFixture _testFixture = fixture;
