...
namespace CrystalSharp.Sagas.Tests.IntegrationTests
{
    ...
    public class MongoDbSagaOrchestratorTests(MongoDbSagaTestFixture fixture) : IClassFixture<MongoDbSagaTestFixture>
    {
        private readonly MongoDbSagaTestFixture _testFixture = fixture;
