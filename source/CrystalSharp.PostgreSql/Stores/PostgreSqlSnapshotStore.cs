...
{
    public class PostgreSqlSnapshotStore(
        string eventStoreConnectionString,
        bool useSchema,
        string schema) : SqlSnapshotStorePersistence(new DbManager(new NpgsqlConnection(eventStoreConnectionString)), new ("\"", "\"", useSchema, schema)), ISnapshotStore
    {
