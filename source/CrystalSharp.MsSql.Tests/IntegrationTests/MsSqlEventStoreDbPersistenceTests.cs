...
{
    [Trait(TestSettings.Category, TestType.MsSqlEventStoreDbIntegration)]
    public class MsSqlEventStoreDbPersistenceTests(MsSqlEventStoreTestFixture fixture) : IClassFixture<MsSqlEventStoreTestFixture>
    {
        private readonly MsSqlEventStoreTestFixture _testFixture = fixture;
