...
{
    public class MySqlSnapshotStore(
        string eventStoreConnectionString,
        bool useSchema,
        string schema) : SqlSnapshotStorePersistence(new DbManager(new MySqlConnection(eventStoreConnectionString)), new("`", "`", useSchema, schema)), ISnapshotStore
    {
