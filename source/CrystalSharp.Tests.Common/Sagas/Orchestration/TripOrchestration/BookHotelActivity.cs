...
{
    public class BookHotelActivity(IInMemoryDataContext dataContext) : ISagaActivity
    {
        ...
        public async Task<SagaTransactionResult> Execute(SagaOrchestratorContext sagaContext, CancellationToken cancellationToken = default)
        {
            ...
            trip.BookHotel(transaction.Hotel, transaction.ReservationAmount, transaction.HotelReservationPaidByCustomer);
